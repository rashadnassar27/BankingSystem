 ...
 * @version 1.0 
 */
public class ClientWithdrawPanel extends AbstractBankClientPanels {
	...
	//client withdraw panel constractor
	public ClientWithdrawPanel() throws ParseException, IOException {
		init();
	}
